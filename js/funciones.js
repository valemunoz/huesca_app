...
function loadMenu(div)
{
	...
	menu +="		<li><a class='li_a' href='javascript:loadOferta();' data-transition='flow'><img class='menu_img' src='img/ofertas.png'></a></li>";
	menu +="		<li><a class='li_b' href='javascript:loadComercio();' data-transition='flow'><img class='menu_img' src='img/comercio_dia.png'></a></li>";
	menu +="		<li><a class='li_a' href='javascript:loadComerciosAsociados();' data-transition='flow'><img class='menu_img' src='img/comercios.png'></a></li>";
	menu +="		<li><a class='li_b' href='javascript:loadMapa();'><img class='menu_img' src='img/mapa.png'></a></li>";
	menu +="		<li><a class='li_a' href='javascript:loadBuscador();' data-transition='flow'><img class='menu_img' src='img/buscador.png'></a></li>	";
...
function loadMenuOff()
{
	...
	menu +="		<li><a class='li_a li_opaco' href='#' id='open-popupArrow' class='clickable-area' data-transition='flow'><img class='menu_img' src='img/ofertas.png'></a></li>";
	menu +="		<li><a class='li_b ' href='javascript:loadComercio();'  href='#' data-transition='flow'><img class='menu_img' src='img/comercio_dia.png'></a></li>";
	menu +="		<li><a class='li_a' href='javascript:loadComerciosAsociados();' data-transition='flow'><img class='menu_img' src='img/comercios.png'></a></li>";
	menu +="		<li><a class='li_b' href='javascript:loadMapa();'><img class='menu_img' src='img/mapa.png'></a></li>";
	menu +="		<li><a class='li_a' href='javascript:loadBuscador();' data-transition='flow'><img class='menu_img' src='img/buscador.png'></a></li>	";
	menu +="</ul></div>";
